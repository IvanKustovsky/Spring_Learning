...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        vehicle.setName("Renault Laguna 2");
        System.out.println("Vehicle name from none-spring Context is: " + vehicle.getName());
        ...
        * */
        ...
        System.out.println("String value from spring Context is: " + num);
